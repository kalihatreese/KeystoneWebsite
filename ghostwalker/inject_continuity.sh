...
mkdir -p "$GW_ROOT/logs/daily_summaries"

echo "📝 Injecting Continuity & CSV Generation Logic..."
cat > "$GW_ROOT/apps/continuity.py" << 'INNER_EOF'
import os
import csv
...
echo "🚀 Running initial Checkpoint..."
